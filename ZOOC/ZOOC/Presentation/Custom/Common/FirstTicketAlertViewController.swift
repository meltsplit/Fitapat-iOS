...
protocol FirstTicketAlertViewDelegate: AnyObject {
    func firstTicketConfirmButtonDidTap()
}

final class FirstTicketAlertViewController: UIViewController {
    
    private unowned var delegate: FirstTicketAlertViewDelegate
    ...
    init(delegate: FirstTicketAlertViewDelegate) {
    ...
    private func style() {
        ...
        imageView.do {
            $0.image = .graphicsArtist
            $0.contentMode = .scaleAspectFit
            $0.clipsToBounds = true
        }
        
        subdescriptionLabel.do {
            $0.text = "내가 만든 AI 캐릭터로 커스텀 제품을\n구매하면 5장을 무료로 또 드릴게요!"
            $0.font = .zw_Body2
            $0.textColor = .zw_gray
            $0.numberOfLines = 2
            $0.setAttributeLabel(targetString: ["5장을 무료로"],
                                 color: .zw_point,
                                 font: .zw_Body2,
                                 alignment: .center)
        }
    ...
    private func layout() {
        ...
        confirmButton.snp.makeConstraints {
            $0.top.equalTo(subdescriptionLabel.snp.bottom).offset(24)
            $0.horizontalEdges.equalToSuperview().inset(28)
            $0.height.equalTo(50)
    ...
    private func bind() {
        ...
        confirmButton.rx.tap
            ...
            .bind(onNext: delegate.firstTicketConfirmButtonDidTap)
            .disposed(by: disposeBag)
    }
}
